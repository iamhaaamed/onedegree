 ...
 * icon?: {name: string, Component?: React.ReactNode, size?: number, color?: import('react-native').ColorValue,
        ...
        <View
            ...
            {icon ? (
                <MIcon
                    ...
                    style={[styles.iconLeft, icon.style]}
                    color={icon.color ?? textAndIconColor}
                />
            ) : (
                <>
