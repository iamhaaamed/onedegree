...
<MText  textStyle={COMMON.TxtSectionQuestion96} >We’re so excited to help you find the perfect skilled career that is both high-paying and doesn’t require college debt. </MText>
<MButton onPress={onPress} style ={COMMON.ButtonRect98} containerStyle={COMMON.Button97} 
 text="Let’s get started!" textStyle ={COMMON.TextsButton99} 
gradient={{colors:[COLORS.Color323,COLORS.Color148,COLORS.Color912,COLORS.Color674,COLORS.Color455,COLORS.Color240,],start: { x: -0.15500132739543915, y:0.6157848834991455},end: { x: 1.014054298400879, y:0.17686034739017487}}}
/>
</View>
